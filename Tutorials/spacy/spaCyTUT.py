# this is taken from this tutorial:
...
#
#  spaCy does tokenization, sentence recognition, part of speech tagging,
# lemmatization, dependency parsing, and named entity recognition all at once!
#
...
allWords = list({w for w in parser.vocab if w.has_vector
                 and w.orth_.islower() and w.lower_ != "nasa" and norm(w.vector) > 0})
...
#
# You can do cool things like extract Subject, Verb,
# Object triples from the dependency parse if you use my code in
# subject_object_extraction.py. Note: Doesn’t work on complicated sentences.
# Fails if the dependency parse is incorrect.
#
