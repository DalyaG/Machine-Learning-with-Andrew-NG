...
# Step 1 - load data
# 1.1 load json file
temp = open('/home/baralya/PycharmProjects/tutorials/%s.json'%filename)
...
# save trained model
articles2vec.save('/home/baralya/PycharmProjects/tutorials/%sTrained.w2v'%filename)
...
# save embeddings
with open('/home/baralya/PycharmProjects/tutorials/embeds_and_dics_%s.pkl'%filename,'wb') as fp:
    pickle.dump((embedding, idx2word, word2idx),fp,-1)
with open('/home/baralya/PycharmProjects/tutorials/indexed_corpus_%s.pkl'%filename,'wb') as fp:
